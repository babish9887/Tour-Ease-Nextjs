            ...
            <nav className="flex justify-between flex-col sm:flex-row items-center py-2 fixed w-[calc(100vw-2rem)] top-2 mr-4 ml-4 z-50 bg-transparent">
                  <div className="flex backdrop-blur-2xl grainy/90 bg-slate-100/40 justify-between w-full sticky top-0 h-[4.5rem] items-center px-4 py-2 rounded-xl shadow-md">
                        ...
                        <div className="sm:flex md:gap-6 sm:gap-2 items-center hidden font-semibold">
                              <Link
                                    className={`hover:bg-gray-200/70 px-3 py-2 rounded-md ${pathName === "/" ? "text-green-600" : null
                                          }`}
                                    href={"/"}
                              >
                                    Home
                              ...
                              {session?.user?.role !== "GUIDE" && <Link
                                    className={`hover:bg-gray-200/70 px-3 py-2 rounded-md ${pathName === "/getguides" ? "text-green-600" : null
                                          }`}
                                    href={"/getguides"}
                              >
                                    Get Guides
                              ...
                              {session?.user?.role !== "GUIDE" ? <Link
                                    className={`hover:bg-gray-200/70 px-3 py-2 rounded-md ${pathName === "/mybookings" ? "text-green-600" : null
                                          }`}
                                    href={"/mybookings"}
                              >
                                    My Bookings
                                    ...
                                    :
                                    <Link
                                          className={`hover:bg-gray-200/70 px-3 py-2 rounded-md ${pathName === "/guide/mybookings" ? "text-green-600" : null
                                                }`}
